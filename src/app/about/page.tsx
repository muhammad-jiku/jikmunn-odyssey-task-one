...
export const metadata: Metadata = {
  title: "About — Jikmunn's Odyssey",
  description:
    "Jikmunn's Odyssey is a curated marketplace for thoughtfully designed products, built by a small team that cares about craft and clarity.",
};
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_1fr]">
            <div>
              ...
              <p className="mt-5 max-w-xl text-base text-foreground/70 sm:text-lg">
                Jikmunn&apos;s Odyssey started as a weekend side project — a small list of
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-[var(--radius-lg)] border border-border bg-surface-muted shadow-[var(--shadow-elevated)]">
              <Image
                ...
                alt="Jikmunn's Odyssey team workspace"
                fill
